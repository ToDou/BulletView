...
public class MainActivity extends Activity {
    ...
    private String[] comments = new String[]{"你做个值班背景人应该很潇洒，都喜欢段子、糗事，根本就不会看", "导演瞄到，说这个", "做来做去跟动态", "槽的方式来表达自我比如你可以说你基友没节操你也可", "作部，结果舞美总监就",
            "点的正能量。他们会说，哇塞，这高贵冷艳的抠脚少女，原来内心也很柔软，这种会戳到你内心深处的东西就让人停不下来（众笑）。大家不要笑", "来做去", "方式来表达自我。比如你可以说你基友没节方式来表达自我。比如你可以说你基友没节", "方式来表达自我。比如你可以说你基友没节", "方式来表基友没节", "没节", "表达自我。比如你可以说你基表达自我。比如你可以说你基"};
